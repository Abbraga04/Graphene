...
export default function ProfilePage({ params }: { params: Promise<{ username: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-bg">
      {/* Header */}
      <header className="h-14 border-b border-border flex items-center px-6 bg-surface">
        ...
        <div className="border border-border p-6 mb-6">
          <div className="flex items-start gap-4">
            {profile.avatar_url ? (
              ...
              <div className="w-16 h-16 border border-border bg-surface-2 flex items-center justify-center text-xl text-accent font-bold">
